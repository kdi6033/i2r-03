...
|3|릴레이상태 전송|보드의 현재 상태를 mqtt로 보낸다.<br>요청 : {'order':2,'no'=1,'value':true} <br> 응답예시 {"type":3,"email":"kdi6033@gmail.com","mac":"EC:64:C9:43:E8:B8","temp":28.4,"humi":38,"in":[0,0,0,0],"out":[0,0,0,0]}|
