...
import { ModalController } from '@ionic/angular'; // Import ModalController here
...
export class Tab2Page implements OnDestroy, DoCheck {
  ...
  relayStates = [true, true, true, true, false, false, false, false];
  relays: Relay[] = [
  ...
  ngOnInit() {
    ...
    } else if(!this.globalService.wifi.outTopic){
